...
modules::Exception - Utility functions for error handling
...
=head2 throw
  ...
  Example    : use modules::Exception qw(throw);
...
=head2 warning
  ...
  Example    : use modules::Exception qw(warning)
               warning('This is a warning');
...
=head2 info
  ...
  Example    : use modules::Exception qw(verbose info)
...
=head2 verbose
  ...
  Arg [1]    : (optional) int 
  Example    : use modules::Exception qw(verbose warning);
...
=head2 stack_trace_dump
  ...
  Example    : use modules::Exception qw(stack_trace_dump);
...
=head2 stack_trace
  ...
  Arg [1]    : none
  Example    : use modules::Exception qw(stack_trace)
...
=head2 deprecate
  ...
  Example    : use modules::Exception qw(deprecate)
               sub old_sub {
...
=head2 try/catch
  ...
  Example    : use modules::Exception qw(throw try catch)
               The syntax is:
